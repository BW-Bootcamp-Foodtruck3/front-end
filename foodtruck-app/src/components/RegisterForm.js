...
const RegistrationForm = () => {
    ...
    return (
        <form onSubmit={submitHandler} className="registration-form">
            <div className="registration-form__first-container">
                <div className="input-container">
                    <label htmlFor="business-name__id" className="input-container__label">Business Name:</label>
                    <input 
            ...
            <div className="registration-form__second-container">
            ...
            <div className="registration-form__third-container">
                <div className="input-container">
                    <label htmlFor="tos-id" className="input-container__label">Agree to Terms of Service:</label>
                    <input 
                        className="tos-checkbox"
                        type="checkbox"
                        name="tos"
                        id="tos-id"
                        value={inputState.tos}
                        onChange={changeHandler}
                    ></input>
                </div>
